...
window.onload = function () {
        var image = document.querySelector("img.targetImage");
        var imageSection = document.querySelector('.imageSection .targetImage');
        var appendColors = function (colors, root) {
            colors.forEach(function (value, index) {
                ...
                root.appendChild(swatchEl);
            });
        };

        // Dominant Color
        var dominantColor = getDominantColor(image);
        var dominantSwatch = document.querySelector('.dominantColor .swatches');
        appendColors([dominantColor], dominantSwatch);

        // Palette
        var colorCount =image.getAttribute('data-colorcount') ? image.data('colorcount') : 0xFF;
        var medianPalette = createPalette(image, colorCount);
        var medianCutPalette = document.querySelector('.medianCutPalette .swatches');
